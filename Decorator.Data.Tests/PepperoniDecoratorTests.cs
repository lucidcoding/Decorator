...
{
    [TestFixture]
    public class PepperoniDecoratorTests
    {
        ...
        {
            Assert.That((_pizza as PepperoniDecorator).ExtraSpicy, Is.True);
        }

        [Test]
        public void GivenPizzaIsSavedWhenPizzaIsLoadedThenCostIsCorrect()
        {
            Assert.That(_pizza.Cost, Is.EqualTo(8.99m));
        }
    }
}
